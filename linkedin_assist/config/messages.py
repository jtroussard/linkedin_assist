...
MESSAGES = [
	"{city} area IT job seekers, Dollar Bank is looking for a wicked talented {title} to join our team! Interested? Follow this link to apply. Referral mentions greatly appreciated! Also, did you know? This post was generated by a python script? Check my GitHub (https://github.com/jtroussard) account for more details.",
	"$Calling {city} area {title}. Dollar Bank is hiring! Interested? Follow this link. Referral mentions greatly appreciated. Also, did you know this post was automatically shared by a program? Check out my GitHub repo to learn more. (https://github.com/jtroussard)",
	"$Attention all {city} area {title}. Dollar Bank is hiring! Interested? Follow this link. Referral mentions greatly appreciated. Also, did you know this post was automatically shared by a program? Check out my GitHub repo to learn more. (https://github.com/jtroussard)",
	"Do you have experience as a {title}? Dollar Bank is looking for talented individuals to join our team. Follow the main link for more details. Referral mentions greatly appreciated. Also did you know this post share was automated using LinkedIn\'s API and some python code? Code is available on my GitHub account(https://github.com/jtroussard).",
